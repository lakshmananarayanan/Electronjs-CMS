function new1(){
    ...
    document.getElementById('save').onclick = function(){
        ...
        var hn=document.getElementById("h_name").value
        ...
        var dept=document.getElementById("dept").value
         ...
         var options = {
            ...
            args : [fid,fn,hn,dob,age,bg,mn,addrs,email,c1,c2,c3,c4,c5,i1,i2,i3,i4,i5,b1,b2,b3,b4,b5,y1,y2,y3,y4,y5,p1,p2,p3,p4,p5,exp,dept]
        } 
     var show=new python.PythonShell("faculty.py", options); 
